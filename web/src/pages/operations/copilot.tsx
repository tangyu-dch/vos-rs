      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        <div className="flex-1 flex flex-col min-h-0 justify-between items-center w-full">
          ...
          <div className="w-full px-4 py-4 shrink-0 bg-transparent">
            <div className="w-full max-w-3xl mx-auto rounded-3xl border-2 border-default-200 hover:border-primary/40 focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/10 bg-content1 shadow-lg p-2 flex items-center gap-2 transition-all duration-200">
              <Input
                variant="flat"
                classNames={{
