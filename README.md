...
| 性能维度 | 测量指标 / 极限能力 | 技术实现 / 备注 |
| :--- | :--- | :--- |
| **媒体转发能力** | **10 万路**并发通道 | 基于 eBPF / XDP 内核旁路加速，零拷贝转发 |
| **REST API 响应** | **P99 < 100ms** | Axum 异步 Web 框架，全内存缓存热路径加速 |
| **内存占用与稳定性** | **稳态无内存泄漏** | Rust 强类型所有权内存管理，零 GC 停顿 |
