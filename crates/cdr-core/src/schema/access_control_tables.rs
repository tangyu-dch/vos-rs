...
('subscribers', '号码资源', 'users', 30),
('routing', '中继路由', 'server', 40),
...
('extensions', 'subscribers', '分机管理', '/extensions', 'users', 'extensions.view', 10),
('numbers', 'subscribers', '号码管理', '/numbers', 'book', 'numbers.view', 20),
('did', 'subscribers', '呼入目标', '/did-destinations', 'branch', 'termination.view', 30),
('routes', 'routing', '路由策略', '/routing', 'fork', 'routing.view', 10),
('access_trunks', 'routing', '接入中继', '/trunks/access', 'server', 'trunks.view', 20),
('egress_trunks', 'routing', '落地中继', '/trunks/egress', 'server', 'trunks.view', 30),
('egress_groups', 'routing', '落地分组', '/egress-groups', 'branch', 'termination.view', 40),
('caller_pools', 'routing', '号码池组', '/caller-pools', 'grid', 'termination.view', 50),
('ivr', 'call_center', '语音导航', '/ivr', 'branch', 'ivr.view', 10),
